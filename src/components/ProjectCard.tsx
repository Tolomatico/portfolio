...
export default function ProjectCard({ item }: ProjectCardProps) {
  return (
    <motion.div
      ...
      className="group flex w-full max-w-lg flex-col gap-4 overflow-hidden rounded-2xl border border-slate-200/70 bg-white/80 p-4 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl dark:border-slate-700/60 dark:bg-slate-900/80 backdrop-blur"
    >
      <div className="relative aspect-video w-full overflow-hidden rounded-xl bg-slate-200/60 dark:bg-slate-800/60">
        <Image
          src={item.img}
